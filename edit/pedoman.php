...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM pedoman WHERE id = '$id'");
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="../controllerEdit/pedoman.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $data['id']?>">
                <div class="mb-3">
                    <label for="awal" class="form-label">Tanggal Awal</label>
                    <input type="date" class="form-control" value="<?= $data['awal'] ?>" name="awal" id="awal">
                </div>
                <div class="mb-3">
                    <label for="akhir" class="form-label">Tanggal Akhir</label>
                    <input type="date" class="form-control" name="akhir" id="akhir" value="<?= $data['akhir'] ?>">
                </div>
                <div class="mb-3">
                    <div class="row">
                        <div class="col-md-12">
